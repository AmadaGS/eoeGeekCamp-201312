...
public class Test003 {
	...
	static final String FILENAME="users5.xml";
	...
	private static ArrayList<User> initUsers() {
		...
		list.add(new User(1001, "¡ı–Ò—Ù", "1234", "5667886", "xlu@qq.com"));
		list.add(new User(1002, "÷‹“ª¡˙", "1234", "5667886", "xlu@qq.com"));
		list.add(new User(1003, "’‘ø°", "1234", "5667886", "xlu@qq.com"));
		list.add(new User(1004, "≈À‘∆ø≠", "1234", "5667886", "xlu@qq.com"));
		list.add(new User(1005, "Œ‚‘Ω", "1234", "5667886", "xlu@qq.com"));
		return list;
	}
